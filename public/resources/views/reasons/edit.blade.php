...
<div class="col-lg-6">
    <div class="card">
        ...
        <div class="card-body card-block">
            <form action="{{route('admin.reasons.update', $reason)}}" method="post" class="">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <select  class="form-control" name="group_id">
                            ...
                            <option value="{{$group->id}}" @if($group->id ==$reason->group_id)selected="selected" @endif>{{$group->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
