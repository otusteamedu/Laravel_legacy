 ...
 * Generated for Laravel 6.11.0 on 2020-02-11 13:06:37.
 *
...
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Wishlist[]|Wishlist create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Wishlist[]|Wishlist make($attributes = [])
    */
    class WishlistFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|WishlistProduct[]|WishlistProduct create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|WishlistProduct[]|WishlistProduct make($attributes = [])
    */
    class WishlistProductFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
