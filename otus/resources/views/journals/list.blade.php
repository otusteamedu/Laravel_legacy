            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <div style="float:left;font-size: 36px">
                        <a href="{{route('admin.journals.create')}}"><span
                        ...
                        @foreach ($journals as $journal)
                            <li class="list-group-item">
                                ...
                                <div class="pull-right action-buttons">
                                    ...
                                    <a href="{{route('admin.journals.show', ['journal' => $journal])}}"><span
                                            class="glyphicon glyphicon-pencil">Подробнее</span>
                                    </a>

                                    <a href="{{route('admin.journals.edit', ['journal' => $journal])}}"><span
                                            class="glyphicon glyphicon-pencil">Редактировать</span>
                                    </a>

                                    <a href="{{route('admin.journals.destroy', ['journal' => $journal])}}"  class="js-destroy trash"><span
