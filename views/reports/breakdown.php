...
?>
  ...
  <?php $form = ActiveForm::begin([
          'method' => 'get',
          'action' => Url::toRoute(['reports/breakdown']),
...
HTML;
    ...
    <div class="col-md-3 col-sm-4">
      ...
      <div class="form-group">
        ...
        <a class="btn btn-default" href="<?=Html::encode(Url::toRoute(['reports/excel1', 'users'=>$selected_users, 'from'=>$from, 'to'=>$to]))?>">В Excel</a>
      </div>
      <?php
      ...
      <table class="table table-striped table-bordered tablesorter">
        <thead>
          <tr>
            ...
            <th><a class="tablesort">Исполнитель</a></th>
