...
$this->title = 'Отчет о моем затраченном времени';
...
?>
  ...
  <?php $form = ActiveForm::begin([
          'method' => 'get',
          'action' => Url::toRoute(['reports/my']),
          'enableClientValidation'=>false,
  ]);
  ?>
  <div class="row" style="padding-bottom: 1em;">
    <div class="col-sm-12 col-md-6" style="padding: 0 20px">
...
HTML;
    ...
    <div class="col-md-3 col-sm-6">
      ...
      <div class="form-group">
        ...
        <a class="btn btn-default" href="<?=Html::encode(Url::toRoute(['reports/excel', 'from'=>$from, 'to'=>$to]))?>">В Excel</a>
      </div>
    </div>
  </div>
  <?php ActiveForm::end(); ?>
