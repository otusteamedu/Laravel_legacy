...
{
    /**
     * Make permission name from ability and model class name
     *
     ...
     * @return string
     */
    public static function makeNameFromAbility(string $ability, string $modelClass): string
    {
        return sprintf('%s %s', $ability, Models::getTableName($modelClass));
    }
}
