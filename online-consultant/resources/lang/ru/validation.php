...
return [
    ...
    */
    ...
    'custom' => [
        'widget_id'  => [
            'exists' => 'Виджет не принадлежит выбранной компании.'
        ],
        'lead_id'    => [
            'exists' => 'Лид не принадлежит выбранной компании.'
        ],
        'manager_id' => [
            'exists' => 'Пользователь не принадлежит выбранной компании.'
        ],
        'company_id' => [
            'exists' => 'Компания не существует.'
        ],
        'roles'      => [
            'required' => 'Вы должны указать хотя бы одну роль.'
        ]
    ],
