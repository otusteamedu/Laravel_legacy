...
const mutations = {
    ...
    // UPDATE_PERMISSIONS_FIELD(state, payload) {
        // if (!state.fields.permissions.includes(payload.id)) {
        //     state.fields.permissions.push(payload.id);
        // } else {
        //     state.fields.permissions = state.fields.permissions.filter(permissionId => permissionId !== payload.id);
        // }
    // },
...
const actions = {
    ...
    updatePermissionsField(context, value) {
        context.commit('UPDATE_PERMISSIONS_FIELD', value);
    },
    clearFields(context) {
