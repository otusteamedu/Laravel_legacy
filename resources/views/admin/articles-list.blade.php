    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4 ">
        <div class="table-wrapper">
            <div class="table-title border-bottom">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>@lang('messages.admin.articles-list.title')</h2>
                    </div>
                    <div class="col-sm-6">
            ...
            <div id="data-list" class="table-responsive">
                <table class="table table-striped table-hover table-sm">
                    <thead>
                    <tr>
                        <th>@lang('messages.admin.article.id')</th>
                        <th>@lang('messages.admin.article.title')</th>
                        <th>@lang('messages.admin.article.category')</th>
                        <th>@lang('messages.admin.article.author')</th>
                        <th>@lang('messages.admin.article.published_date')</th>
                        <th>@lang('messages.admin.article.state')</th>
                        <th>@lang('messages.admin.article.actions')</th>
                    </tr>
                    </thead>
                    <tbody>
