...
@section("content")
    <div class="row">
        <div class="col-12">
            ...
            {{ Form::model( $news, ['route' => ['admin.news.update', $news->id], 'method' => 'put', 'role' => 'form'] ) }}
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            {{ Form::label('created_at', 'Создан', ['class' => 'control-label']) }}
                            <p class="control-label">{{$news->created_at ?? '-'}}</p>
                        </div>
                        <div class="form-group">
                            {{ Form::label('updated_at', 'Изменен', ['class' => 'control-label']) }}
                            <p class="control-label">{{$news->updated_at ?? '-'}}</p>
                        </div>
                        <div class="form-group form-check">
                            {{ Form::checkbox('active', $news->active, $news->active, ['class' => 'form-check-input']) }}
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('picture_id', $news->picture_id, ['class' => 'form-control']) }}
                        </div>
                        <div class="form-group">
