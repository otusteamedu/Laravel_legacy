                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('locality', '', ['class' => 'form-control']) }}
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('timezone', '', ['class' => 'form-control']) }} <!-- @ToDo: Добавить в миграцию часовой пояс -->
                        </div>
                        <div class="form-group">
                            {{ Form::label('email_verified_at', 'Email подтвержден (дата)', ['class' => 'control-label']) }}
                            {{ Form::text('email_verified_at', '', ['class' => 'form-control']) }}
                        </div>
                        <div class="form-group">
                            {{ Form::label('phone_verified_at', 'Телефон подтвержден (дата)', ['class' => 'control-label']) }}
                            {{ Form::text('phone_verified_at', '', ['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
