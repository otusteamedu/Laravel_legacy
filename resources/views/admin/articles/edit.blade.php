...
@section('breadcrumbs', '')
@section('h1')
    Редактирование статьи №{{$article->id}}
@stop
...
@section("content")
    <div class="row">
        <div class="col-12">
            ...
            {{ Form::model( $article, ['route' => ['admin.articles.update', $article->id], 'method' => 'put', 'role' => 'form'] ) }}
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            {{ Form::label('created_at', 'Создан', ['class' => 'control-label']) }}
                            <p class="control-label">{{$article->created_at ?? '-'}}</p>
                        </div>
                        <div class="form-group">
                            {{ Form::label('updated_at', 'Изменен', ['class' => 'control-label']) }}
                            <p class="control-label">{{$article->updated_at ?? '-'}}</p>
                        </div>
                        <div class="form-group form-check">
                            {{ Form::checkbox('active', $article->active, $article->active, ['class' => 'form-check-input']) }}
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('picture_id', $article->picture_id, ['class' => 'form-control']) }}
                        </div>
                        <div class="form-group">
