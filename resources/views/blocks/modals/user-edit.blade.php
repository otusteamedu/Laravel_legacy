    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title">Редактирование пользователя</h5>
            ...
            <div class="modal-body">
                {{ Form::open(['url'=> route('users.store')]) }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::email('email', null, ['class'=> 'form-control', 'id' => 'modalField-email']) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('group_id', 'Группа', null, ['class'=> 'col-form-label']) }}
                        {{ Form::select('group_id', $groupList,  null, ['class'=> 'form-control', 'id' => 'modalField-group_id']) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('avatar', 'Аватар', null, ['class'=> 'col-form-label']) }}
                        {{ Form::text('avatar', null, ['class'=> 'form-control', 'id' => 'modalField-avatar']) }}
                    </div>
