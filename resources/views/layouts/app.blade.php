    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                {{ config('app.name') }}
                @guest()
                    <small>— @lang('landing.slogan')</small>
                @endguest
            </a>
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link @if(Route::is('home'))active @endif"
                               href="{{ route('home') }}">@lang('home.title')</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if(Route::is('projects.*'))active @endif"
                               href="{{ route('projects.index') }}">@lang('projects.title')</a>
                        </li>
                    @endauth
                </ul>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @guest
                        <li class="nav-item mr-5">
                            <a class="nav-link" href="https://github.com/phptrack/phptrack.io" target="_blank">GitHub <i
