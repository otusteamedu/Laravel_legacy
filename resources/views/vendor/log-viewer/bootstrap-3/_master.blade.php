    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="{{ App\Helpers\RouteBuilder::localeRoute('log-viewer::dashboard') }}" class="navbar-brand">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav">
                    <li class="{{ Route::is('log-viewer::dashboard') ? 'active' : '' }}">
                        <a href="{{ App\Helpers\RouteBuilder::localeRoute('log-viewer::dashboard') }}">
                            <i class="fa fa-dashboard"></i> Dashboard
                        </a>
                    </li>
                    <li class="{{ Route::is('log-viewer::logs.list') ? 'active' : '' }}">
                        <a href="{{ App\Helpers\RouteBuilder::localeRoute('log-viewer::logs.list') }}">
